          ...
          >
            ...
            <div
              style={{
                ...
                opacity: typed < URL_TEXT.length && Math.floor(frame / 8) % 2 === 0 ? 1 : 0,
              }}
            />
            <div
              style={{
            ...
            >
              <div
                style={{
                  ...
                  fontWeight: 600,
                  color: COLORS.green,
                  opacity: interpolate(frame, [1.55 * fps, 1.75 * fps], [0, 1], {
                    extrapolateLeft: "clamp",
                    extrapolateRight: "clamp",
        ...
        <AbsoluteFill style={{ alignItems: "center", justifyContent: "center" }}>
          <div
            style={{
              ...
              translate:
                "0px " +
                interpolate(frame, [0.32 * fps, 0.7 * fps], [APP.previewY + 22, APP.previewY], {
                  extrapolateLeft: "clamp",
                  extrapolateRight: "clamp",
                  easing: Easing.bezier(0.16, 1, 0.3, 1),
                }) +
        ...
        <AbsoluteFill style={{ alignItems: "center", justifyContent: "center" }}>
          <div
            style={{
              ...
              translate:
                "0px " +
                interpolate(frame, [1.7 * fps, 2.4 * fps], [APP.previewY + 34, APP.previewY], {
                  extrapolateLeft: "clamp",
                  extrapolateRight: "clamp",
                  easing: Easing.bezier(0.16, 1, 0.3, 1),
                }) +
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 11, marginTop: 14 }}>
        <div
          style={{ width: 30, height: 30, borderRadius: 15, backgroundColor: "#EEF1F7" }}
        />
        <div>
          <div
            style={{ width: 210, height: 11, borderRadius: 6, backgroundColor: "#EEF1F7" }}
          />
          <div
            style={{
              width: 132,
      ...
      <div
        style={{
          ...
          left: interpolate(frame, [0.45 * fps, 1.55 * fps], [-180, width + 60], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
