    ...
    <AbsoluteFill style={{ alignItems: "center", justifyContent: "center" }}>
      <div
        style={{
          ...
          // Flou résiduel : plus la vidéo est petite, plus elle est loin.
          filter:
            "blur(" +
            ((1 - appear) * 10 +
              leave * 12 +
              DOF.fromScale(satellite.scale, DOF.background, 0.5)) +
            "px)",
          translate:
            satellite.x + "px " + (satellite.y + float + leave * 60) + "px",
